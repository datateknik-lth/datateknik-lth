...
add s0, s0, s1              # Adderar innehållet i s0 med s0 och lägger det i det mest vänstra, s0.
...
# Adresseringsmetoder
lw t0, 4(t3)                # t3 håller en register-adress. Lägg till 4 på denna adress och ladda in 
